#different coalescence rates, asymmetric
...
time_m <- system.time(mult <- mcmapply(mult.small,noise=1/200,gam=gam_values,const_coal=TRUE,symmetric=FALSE,
                                       seed=rep(seeds,4),mc.cores=6,SIMPLIFY=FALSE))
save.image("mult_gam_asym.RData")